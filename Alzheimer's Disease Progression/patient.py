...
class Patient: 
    ...
    def __repr__(self):
        return f"{self.DonorID} | sex: {self.sex} | ABeta40 {self.ABeta40} | tTau {self.tTau} | pTau {self.pTau} | Death Age {self.death_age} | Education {self.ed_lvl} | Thal Score {self.thal_score}"
